...
docx4j-8 uses JAXB 2.x (which import javax.xml.bind ). Compare newer docx4j v11.4 which uses Jakarta XML Binding API 3.0 (import jakarta.xml.bind ), and docx4j v11.5.0 which uses JAXB 4.0.x
...
See https://github.com/plutext/docx4j/tree/VERSION_11_5_0
...
11.5.0 is compiled with Java 17, targeting Java 11. If you are not using Java 11 or later, you should stick with docx4j 8.3.x.
