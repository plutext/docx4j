...
import org.docx4j.com.google.common.base.Stopwatch;
...
import org.docx4j.com.google.common.cache.CacheBuilder.NullListener;
...
import org.docx4j.com.google.common.util.concurrent.Futures;
import org.docx4j.com.google.common.util.concurrent.ListenableFuture;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code org.docx4j.com.google.common.collect.MapMaker})
  ...
  static class LoadingValueReference<K, V> implements ValueReference<K, V> {
    ...
    public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
      try {
        ...
        return transform(
            newValue,
            new org.docx4j.com.google.common.base.Function<V, V>() {
              @Override
