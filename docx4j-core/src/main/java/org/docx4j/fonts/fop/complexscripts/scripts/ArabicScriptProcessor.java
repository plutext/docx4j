...
import org.docx4j.fonts.fop.complexscripts.bidi.BidiClass;
import org.docx4j.fonts.fop.complexscripts.bidi.BidiConstants;
...
public class ArabicScriptProcessor extends DefaultScriptProcessor {
    ...
    /** logging instance */
    private static final  Logger log = LoggerFactory.getLogger(ArabicScriptProcessor.class);
