...
abstract public class ToStream extends SerializerBase
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        try {
			NamespaceMappingsAccessor.popNamespaces(m_prefixMap, m_elemContext.m_currentElemDepth, null);
		} catch (Exception e1) {
			throw new org.xml.sax.SAXException("NamespaceMappingsAccessor didn't work", e1);
		} 
...
//                    && !existing_mapping.m_uri.equals(uri))
                    ...
                    Docx4jMappingRecord existing_mapping = null;
                    if (m_prefixMap instanceof Docx4jNamespaceMappings) {
                    	
                    	existing_mapping = ((Docx4jNamespaceMappings)m_prefixMap).docx4jGetMappingFromPrefix(prefix);
                    }
