...
{
	protected static Logger log = LoggerFactory.getLogger(ToXMLSAXHandler.class);
    ...
    public ToXMLSAXHandler()
    {
        ...
        m_prefixMap = new Docx4jNamespaceMappings();
        initCDATA();
    }
...
//            m_saxHandler);        
        try {
			NamespaceMappingsAccessor.popNamespaces(m_prefixMap, m_elemContext.m_currentElemDepth, m_saxHandler);
		} catch (Exception e1) {
