...
```
family = unitsPerEm;usWinAscent;usWinDescent;hheaAscender;hheaDescender;hheaLineGap[;eastAsian[;sTypoAscender;sTypoDescender;sTypoLineGap]]
```

The seventh field flags an East Asian family (its line is 1.3 x the usWin box). Fields 8-10
...
with the invisible paragraph Word had kept on the page before **22 times to Word's twice**,
and with the kept unit that much shorter (the table without its trailing 21.6 or 43.6pt) it
