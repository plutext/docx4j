...
/**
 * <p>Java class for CT_MainMasterChanges complex type.
 * 
...
@XmlType(name = "CT_MainMasterChanges", propOrder = {
    "chgData",
    "sldMasterMkLst",
    "spChg",
    "grpChg",
...
public class CTMainMasterChanges implements Child
{
     ...
     * @return
     *     possible object is
     *     {@link CTMainMasterMonikerList }
     *     
     */
    public CTMainMasterMonikerList getSldMasterMkLst() {
        return sldMasterMkLst;
    }
     ...
     *     
     */
    public void setSldMasterMkLst(CTMainMasterMonikerList value) {
        this.sldMasterMkLst = value;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sldLayoutChg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CTSlideLayoutChanges }
     * 
     * 
     */
    public List<CTSlideLayoutChanges> getSldLayoutChg() {
        if (sldLayoutChg == null) {
            sldLayoutChg = new ArrayList<CTSlideLayoutChanges>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link STMainMasterChangeBit }
     * 
     * 
     */
    public List<STMainMasterChangeBit> getChg() {
        if (chg == null) {
            chg = new ArrayList<STMainMasterChangeBit>();
        }
        return this.chg;
    }
