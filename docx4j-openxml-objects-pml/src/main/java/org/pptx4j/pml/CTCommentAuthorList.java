...
public class CTCommentAuthorList implements Child
{
    ...
    /**
     * Gets the value of the cmAuthor property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cmAuthor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCmAuthor().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CTCommentAuthor }
     * 
     * 
     */
    public List<CTCommentAuthor> getCmAuthor() {
        if (cmAuthor == null) {
            cmAuthor = new ArrayList<CTCommentAuthor>();
        }
