...
/**
 * <p>Java class for ST_SplitterBarState.
 * 
...
public enum STSplitterBarState {
    ...
    public static STSplitterBarState fromValue(String v) {
        for (STSplitterBarState c: STSplitterBarState.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
