...
/**
 * <p>Java class for ST_TLAnimateColorSpace.
 * 
...
public enum STTLAnimateColorSpace {
    ...
    STTLAnimateColorSpace(String v) {
        value = v;
    }
    ...
    public static STTLAnimateColorSpace fromValue(String v) {
        for (STTLAnimateColorSpace c: STTLAnimateColorSpace.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
