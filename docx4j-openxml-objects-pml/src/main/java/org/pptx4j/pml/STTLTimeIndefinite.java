...
/**
 * <p>Java class for ST_TLTimeIndefinite.
 * 
...
public enum STTLTimeIndefinite {
    ...
    public static STTLTimeIndefinite fromValue(String v) {
        for (STTLTimeIndefinite c: STTLTimeIndefinite.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
