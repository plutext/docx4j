...
/**
 * <p>Java class for CT_DoughnutChart complex type.
 * 
 ...
 *         &lt;element name="holeSize" type="{http://schemas.openxmlformats.org/drawingml/2006/chart}CT_HoleSize" minOccurs="0"/&gt;
...
@XmlType(name = "CT_DoughnutChart", propOrder = {
    "varyColors",
    "ser",
    "dLbls",
    "firstSliceAng",
...
public class CTDoughnutChart implements Child
{
     ...
     *     
     */
    public void setHoleSize(CTHoleSize value) {
        this.holeSize = value;
    }
