...
/**
 * <p>Java class for ST_PictureFormat.
 * 
...
public enum STPictureFormat {
     ...
     * 
     */
    @XmlEnumValue("stackScale")
    STACK_SCALE("stackScale");
    private final String value;

    STPictureFormat(String v) {
        value = v;
    }
    ...
    public static STPictureFormat fromValue(String v) {
        for (STPictureFormat c: STPictureFormat.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
