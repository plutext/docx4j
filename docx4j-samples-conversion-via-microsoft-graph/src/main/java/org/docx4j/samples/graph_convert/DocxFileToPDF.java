...
/**
 * This example uses Microsoft Graph to convert a docx file to PDF.
 * 
...
public class DocxFileToPDF {
	...
	public static void main(String[] args) throws IOException, Docx4JException {
		...
		File output = new File(System.getProperty("user.dir")+"/resultZ3.pdf");
		...
		exporter.export(
				new File(System.getProperty("user.dir")+ "/../docx4j-samples-docx4j/sample-docs/sample-docx.docx") , 
				fos); 
