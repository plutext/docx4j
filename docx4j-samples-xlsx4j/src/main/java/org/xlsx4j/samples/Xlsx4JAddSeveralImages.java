 ...
 *
 */
public class Xlsx4JAddSeveralImages {

	
	static org.docx4j.dml.spreadsheetdrawing.ObjectFactory dmlspreadsheetdrawingObjectFactory 
		= new org.docx4j.dml.spreadsheetdrawing.ObjectFactory();
	
	public static void main(String[] args) throws Exception {
	
		String outputfilepath = System.getProperty("user.dir") + "/OUT_Xlsx4JAddImage.xlsx";
		String imagefilePath = System.getProperty("user.dir")+"/blue.png" ;
		String imagefilePath2 = System.getProperty("user.dir")+"/red.png" ;
		
		SpreadsheetMLPackage pkg = SpreadsheetMLPackage.createPackage();
		WorksheetPart worksheet = pkg.createWorksheetPart(new PartName("/xl/worksheets/sheet1.xml"), "Sheet1", 1);

		// Create Drawing part and add to sheet;  there is only ever a single drawing part per sheet 
		Drawing drawingPart = new Drawing();
		Relationship drawingRel = worksheet.addTargetPart(drawingPart);
		
		// Add anchor XML to worksheet;  there is only ever a single drawing object per sheet.
		...
		// Create image parts and add to the one Drawing part
        ...
        BinaryPartAbstractImage imagePart2 
    	= BinaryPartAbstractImage.createImagePart(pkg, drawingPart, 
		...
		CTDrawing drawingsContainer = dmlspreadsheetdrawingObjectFactory.createCTDrawing(); 
		drawingsContainer.getEGAnchor().add( buildDrawingPartContentForImageUsingCode(imageRelID, 714375, 714375, "Picture 1", 2)); 
		drawingsContainer.getEGAnchor().add( buildDrawingPartContentForImageUsingCode(imageRelID2, 914375, 1714375, "Picture 2", 3)); 
        
        drawingPart.setJaxbElement(drawingsContainer);
        
        // .. or build it from an XML string (you'll need to change this to suit 2 images)
		...
		org.docx4j.dml.ObjectFactory dmlObjectFactory = new org.docx4j.dml.ObjectFactory();
                ...
                // TODO, parameterise
		                    ...
		                    transform2d.setExt(positivesize2d); 
		                        positivesize2d.setCx( cx );
		                        positivesize2d.setCy( cy);
		            ...
		            picture.setNvPicPr(picturenonvisual); 
		                ...
		                picturenonvisual.setCNvPr(nonvisualdrawingprops); 
		                    ...
		                    nonvisualdrawingprops.setId( id );
