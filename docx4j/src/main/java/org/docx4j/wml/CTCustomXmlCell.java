...
public class CTCustomXmlCell implements Child
{
    ...
    protected List<JAXBElement<?>> egContentCellContent;
     ...
     * 
     */
    public List<JAXBElement<?>> getEGContentCellContent() {
        if (egContentCellContent == null) {
            egContentCellContent = new ArrayList<JAXBElement<?>>();
        }
