...
public abstract class AbstractFORenderer implements FORenderer {
	...
	protected boolean TEXTBOX_POSTPROCESSING_REQUIRED = false;
		...
		try {
			Source xsltSource = new StreamSource(
						org.docx4j.utils.ResourceUtils.getResource(
								"org/docx4j/convert/out/fo/AbstractFORenderer_POSTPROCESSING.xslt"));
...
//		mso-position-horizontal-relative:text
	 ...
	 * @return
	 */
	private boolean marginTopPositiveCase(Map<String, String> props, Document doc, Element ret, float widthPts,
			NodeList childNodes) {
...
//						doc.createComment("CONTENT GOES HERE"));
				...
				TEXTBOX_POSTPROCESSING_REQUIRED = true;
					...
					if (margin_top==null) {
						...
						if (this.supportsFloat()) {
							...
							if (marginTop<=0) {
								...
								if (marginTopPositiveCase( props, doc, ret, writableWidthPts, modelContent.getChildNodes())) {
