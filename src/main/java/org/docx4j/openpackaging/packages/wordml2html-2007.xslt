...
Modified by Oleg Tkachenko (http://www.xmllab.net) to support images, headers and footers.
...
-Added parameters for storing images: 
 base-dir-for-images and base-virtual-dir-for-images
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	version="1.0"
        exclude-result-prefixes="msxsl ext w o v WX aml w10">
...
Compiler warnings:
  line 3931: Attribute 'style' outside of element.
...
<xsl:template match="WX:sect">
	...
	<!-- Added by Oleg Tkachenko -->
        <xsl:apply-templates select="w:sectPr/w:hdr[@w:type='odd']"/>
	<xsl:call-template name="DisplayBodyContent"/>
	<!-- Added by Oleg Tkachenko -->
	<xsl:apply-templates select="w:sectPr/w:ftr[@w:type='odd']"/>
	</div>
</xsl:template>
