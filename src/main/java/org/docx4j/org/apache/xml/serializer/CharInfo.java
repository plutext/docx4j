...
final class CharInfo {
	 ...
	 * ASCII characters in attribute values, the value is true if the character
	 * in an attribute value should be mapped to a String.
	 */
	private final boolean[]		shouldMapAttrChar_ASCII;

	/**
	 * Array of values is faster access than a set of bits to quickly check
	 * ASCII characters in text nodes, the value is true if the character in a
	 * text node should be mapped to a String.
	 */
	...
	/**
	 * A base constructor just to explicitly create the fields, with the
	 * exception of m_charToString which is handled by the constructor that
	 * delegates base construction to this one.
	 * <p>
	...
	private CharInfo(String entitiesResource, String method, boolean internal) {
		...
		if (Method.XML.equals(method)) {
			// We choose not to escape the quotation mark as &quot; in text
			// nodes
	...
	/**
	 * Tell if the character argument that is from a text node has a mapping to
	 * a String, for example to map '<' to "&lt;".
	 * 
	 * @param value
	 *            the value of a character that is in a text node
	 * @return true if the character has a mapping to a String, such as when
	 *         writing out entity references.
	 * @xsl.usage internal
	 */
	 ...
	 * 
	 * @param charToMap
	 *            The value of the character that is mapped to a String
	 * @param outputString
	 *            The String to which the character is mapped, usually an entity
	 *            reference such as "&lt;".
	 * @return true if the mapping is not one of:
	 *         <ul>
	 *         <li>'<' to "&lt;"
	...
	/**
	 * If the character is in the ASCII range then mark it as needing
	 * replacement with a String on output if it occurs in a text node.
	 * 
	 * @param ch
	 */
	...
	/**
	 * If the character is in the ASCII range then mark it as needing
	 * replacement with a String on output if it occurs in a attribute value.
	 * 
	 * @param ch
	 */
