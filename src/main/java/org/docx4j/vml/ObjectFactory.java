...
public class ObjectFactory {
    ...
    private final static QName _VMLFrame_QNAME = new QName("urn:schemas-microsoft-com:vml", "VMLFrame");
    ...
    /**
     * Create an instance of {@link CTVMLFrame }
     * 
     */
    public CTVMLFrame createCTVMLFrame() {
        return new CTVMLFrame();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CTVMLFrame }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:schemas-microsoft-com:vml", name = "VMLFrame")
    public JAXBElement<CTVMLFrame> createVMLFrame(CTVMLFrame value) {
        return new JAXBElement<CTVMLFrame>(_VMLFrame_QNAME, CTVMLFrame.class, null, value);
    }
