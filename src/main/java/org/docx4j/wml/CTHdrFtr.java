...
/**
 * <p>Java class for CT_HdrFtr complex type.
 * 
...
@XmlType(name = "CT_HdrFtr", propOrder = {
    "egBlockLevelElts"
})
public class CTHdrFtr
    implements Child
{
    ...
    protected List<JAXBElement<?>> egBlockLevelElts;
    @XmlTransient
     ...
     * {@link JAXBElement }{@code <}{@link CTSdtBlock }{@code >}
     ...
     * 
     */
    public List<JAXBElement<?>> getEGBlockLevelElts() {
        if (egBlockLevelElts == null) {
            egBlockLevelElts = new ArrayList<JAXBElement<?>>();
        }
