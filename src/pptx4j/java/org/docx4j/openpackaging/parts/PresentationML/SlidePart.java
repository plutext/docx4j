...
public final class SlidePart extends JaxbPmlPart<Sld> {
	 ...
	 * 
	 * @see
	 * org.docx4j.openpackaging.parts.JaxbXmlPart#setMceIgnorable(org.docx4j.
	 * jaxb.McIgnorableNamespaceDeclarator)
	 * 
	 * @since 3.3.0
	 */
	@Override
	protected void setMceIgnorable(McIgnorableNamespaceDeclarator namespacePrefixMapper) {
		...
		/*
		 * Ensure we declare the namespace. Otherwise Powerpoint 2010 treats the
		 * pptx as corrupt. 2013 and Mac version might repair it, at leat..
		 * 
		...
		// Unlike MainDocumentPart, there is no
	...
	// */
	// @Override
	// public void marshal(java.io.OutputStream os, Object
	// namespacePrefixMapper) throws JAXBException {
	//
	// // Add xmlns:v="urn:schemas-microsoft-com:vml" eg in
	// // <mc:AlternateContent
	// xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006">
	// // <mc:Choice xmlns:v="urn:schemas-microsoft-com:vml" Requires="v">
	// // How? Could marshall to a DOM doc, but there is no way to force the
	// xmlns to be included
	// // where it is not required.
	// // So do string manipulation
	//
	// String xmlString = XmlUtils.marshaltoString( getJaxbElement(), false,
	// true, jc );
	// // include the XML declaration; it'll be UTF-8
	// int pos = xmlString.indexOf(":sld ");
	// xmlString = xmlString.substring(0, pos + 5 ) +
	// "xmlns:v=\"urn:schemas-microsoft-com:vml\" "
	// + xmlString.substring(pos + 5 );
	//
	// try {
	// IOUtils.write(xmlString, os, "UTF-8"); // be sure to write UTF-8
	// irrespective of default encoding
	...
	// *
	// * <p>
	// * Implements <a href="#unmarshalGlobal">Unmarshal Global Root
	// Element</a>.
	// *
	...
	// <p:oleObj xmlns:v="urn:schemas-microsoft-com:vml" imgH="3492360"
	// imgW="4657680" name="Slide" progId="PowerPoint.Slide.8" r:id="rId4"
	// spid="_x0000_s574471">
	// <p:embed/>
	// </p:oleObj>
	// </mc:Choice>
	// *
	// * (note the namespace declaration is legitimately missing from the
	// mc:Choice element;
	// * but this causes Powerpoint 2010 to say the file needs to be
	// repaired!!!).
	// *
	// * I don't think there's a way to cajole JAXB to add a namespace where it
	// is not necessary.
	// * After marshalling, we could post process to add it back in (not with
	// XSLT, since
	// * that'll do its own thing with namespaces, but we could with regex).
	// *
	// * But it is better, I think to always get rid of the alternate content
	// entirely.
	// */
	//
	// log.info("proactively pre-processing to remove any AlternateContent");
	// JaxbValidationEventHandler eventHandler = new
	...
	//
	// Templates mcPreprocessorXslt =
	// JaxbValidationEventHandler.getMcPreprocessor();
	...
	// * See
	// http://old.nabble.com/BinderImpl.associativeUnmarshal-ClassCastException-casting-to-JAXBElement-td32456585.html
	// * and http://java.net/jira/browse/JAXB-874
	// *
	// * java.lang.ClassCastException: org.docx4j.wml.PPr cannot be cast to
	// javax.xml.bind.JAXBElement
	// at
	// com.sun.xml.internal.bind.v2.runtime.ElementBeanInfoImpl$IntercepterLoader.intercept(Unknown
	// Source)
	// at
	// com.sun.xml.internal.bind.v2.runtime.unmarshaller.UnmarshallingContext.endElement(Unknown
	// Source)
	// at
	// com.sun.xml.internal.bind.v2.runtime.unmarshaller.InterningXmlVisitor.endElement(Unknown
	// Source)
	// at
	// com.sun.xml.internal.bind.v2.runtime.unmarshaller.SAXConnector.endElement(Unknown
	// Source)
	// at com.sun.xml.internal.bind.unmarshaller.DOMScanner.visit(Unknown
	// Source)
	// at com.sun.xml.internal.bind.unmarshaller.DOMScanner.scan(Unknown Source)
	// at
	// com.sun.xml.internal.bind.v2.runtime.BinderImpl.associativeUnmarshal(Unknown
	// Source)
	// at com.sun.xml.internal.bind.v2.runtime.BinderImpl.unmarshal(Unknown
	// Source)
	// at
	// org.docx4j.openpackaging.parts.WordprocessingML.MainDocumentPart.unmarshal(MainDocumentPart.java:321)
	// */
	// }
	//
	// return jaxbElement;
	...
	// // unmarshalling here from an Element doesn't implement that fix, so
	// beware.
	//
	// try {
	//
